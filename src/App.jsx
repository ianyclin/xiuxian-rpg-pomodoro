...
{/* 懸浮/點按展開之演算公式面板 (修正版) */}
   <div className="absolute top-full right-0 mt-2 w-64 bg-black/95 border border-rose-500/50 rounded-xl p-4 shadow-[0_0_30px_rgba(244,63,94,0.3)] opacity-0 invisible group-hover:opacity-100 group-hover:visible group-focus:opacity-100 group-focus:visible transition-all duration-300 z-[100] pointer-events-none backdrop-blur-md">
      ...
      {/* 1. 公式描述 */}
      <div className="text-[10px] text-rose-300/40 mb-4 font-mono tracking-tighter leading-tight">
         公式：層數 x 基礎增傷（5%）x 效率加成
      </div>
      
      <div className="text-xs font-mono text-rose-200 flex flex-col gap-2">
         {/* 2. 變量列 */}
         ...
         <div className="flex justify-between items-center">
            <span className="text-white/60">效率加成</span>
...
{/* 4. 目前連擊上限 (修正為顯示總計值) */}
         <div className="flex justify-between items-center text-[10px] font-bold text-orange-400 mt-2 bg-orange-950/40 px-2.5 py-2 rounded border border-orange-500/20">
            <div className="flex flex-col">
               <span>目前連擊上限</span>
               <span className="text-[8px] text-orange-500/50 font-normal">(=基礎上限 50% + 其他加成)</span>
            </div>
            <span className="text-sm">+{(streakCap * 100).toFixed(0)}%</span>
         </div>
      </div>
   </div>
</div>
