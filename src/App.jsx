      ...
      <div className="text-xs font-mono text-rose-200 flex flex-col gap-3">
         ...
         <div className="flex justify-between items-start">
            <div className="flex flex-col">
               ...
               <span className="text-[7px] text-white/30 font-normal mt-0.5 tracking-tighter">
                  (=基礎上限 50% + 其他加成)
               </span>
            </div>
         ...
         <div className="flex justify-between items-center font-black text-rose-400 text-sm drop-shadow-md">
            <div className="flex flex-col">
               <span>總增傷</span>
               <span className="text-[8px] text-rose-500/40 font-normal">（上限 800％）</span>
            </div>
