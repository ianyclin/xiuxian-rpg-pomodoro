export const CHANGELOG_DATA = [
  {
    ...
    date: "2026-03-13",
    title: "法則補全與紅顏傳音",
    desc: "修補多項上古遺留的法則漏洞，並極簡化演算面板，大幅提升修仙沉浸感。",
    changes: [
      "修復【洗髓易經】：成功斬滅死劫突破大境界後，肉身重塑，氣血將自動回滿。",
      "修復【靜音結界】：突破 iOS 裝置在長時間鎖屏後，結算音效被系統強制靜音的底層限制 (Audio Priming)。",
      "優化【雲端容錯】：強化萬仙榜與全域數據的非同步傳輸，處於無網路環境時不再引發系統異常崩潰。",
      "實裝【紅顏傳音】：修行日誌中，道侶傳音將自帶專屬「粉色霓虹」特效與專屬背景，不再錯過隻言片語。",
      "優化【神識面板】：極簡化「連擊演算」懸浮面板資訊，並修復下方境界圖標會穿透頂部介面的視覺錯誤 (Z-Index)。"
    ]
  },
  {
    version: "v4.0.0",
